                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Theme(
                              ...
                              child: ExpansionTile(
                                onExpansionChanged: (value) => setState(() => collapsed = !collapsed),
...
//                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          ...
                          Text('${lot.quantity}m³', style: AppStyles.blackTextStyle.copyWith(color: AppColors.primaryColor, fontSize: 18)),
                          Container(
                            ...
                            child: GestureDetector(
                              child: Row(
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(left: 8),
                                    child: Text('Contacter l\'entreprise', style: AppStyles.primaryTextStyle.copyWith(fontSize: 14, fontWeight: FontWeight.w500)),
                                  ),
                                ],
                              ),
                            ),
