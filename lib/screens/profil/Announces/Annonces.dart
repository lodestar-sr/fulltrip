import 'package:Fulltrip/screens/profil/Announces/publie.dart';
import 'package:Fulltrip/screens/profil/Announces/reserve.dart';
...
class _AnnouncesState extends State<Announces> with SingleTickerProviderStateMixin {
  ...
  initData() {
    ...
    _lotService.getAllLots().then((value) {
      setState(() => Global.announcer = value);
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            color: Color(0xFFF1F1F1), border: Border(bottom: BorderSide(color: AppColors.lightGreyColor, width: 1), top: BorderSide(color: AppColors.lightGreyColor, width: 1))),
                        child: Row(
                          children: [
                            GestureDetector(
                              onTap: () {
