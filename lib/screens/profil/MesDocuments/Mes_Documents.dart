    ...
    return ModalProgressHUD(
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              title: Text('Coordonnées bancaires', style: AppStyles.blackTextStyle),
            ),
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, mainAxisSize: MainAxisSize.max, children: [
                                    Column(
                                      ...
                                      children: [
                                        RichText(
                                          text: TextSpan(
                                            text: "Attestation d'assurance en cours de validité sur 2020",
                                            style: TextStyle(fontSize: 14, color: AppColors.darkColor, fontWeight: FontWeight.w500),
                                            children: <TextSpan>[],
                                          ),
                                        ),
                                        ...
                                        ListTile(
                                          ...
                                          title: Align(
                                            ...
                                            child: Text(
                                              'Ajouter un fichier',
                                              style: AppStyles.navbarActiveTextStyle.copyWith(fontSize: 14, fontWeight: FontWeight.w500),
                                            ),
                                          ),
                                        ),
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  'Supprimer',
                                                  style: AppStyles.navbarActiveTextStyle.copyWith(fontSize: 14, fontWeight: FontWeight.w500, color: AppColors.redColor),
                                                ),
                                              ],
                                            ),
                                          ],
