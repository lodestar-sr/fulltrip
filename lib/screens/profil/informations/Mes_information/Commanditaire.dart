    ...
    return ModalProgressHUD(
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              title: Text('Nom et prénom du commanditaire', style: AppStyles.blackTextStyle),
            ),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          FormFieldContainer(
                                            child: TextFormField(
                                              initialValue: '',
                                              decoration: hintTextDecoration('Entrer Nom du commanditaire'),
                                              validator: (value) => Validators.required(value, errorText: 'Veuillez Entrer Nom du commanditaire'),
                                              keyboardType: TextInputType.text,
                                              style: AppStyles.greyTextStyle.copyWith(fontSize: 18),
                                              onSaved: (val) => setState(() => sponserName = val),
                                            ),
                                          ),
                                          ...
                                          FormFieldContainer(
                                            child: TextFormField(
                                              initialValue: '',
                                              decoration: hintTextDecoration('Entrer Prénom du commanditaire'),
                                              validator: (value) => Validators.required(value, errorText: 'Veuillez Entrer Prénom du commanditaire'),
                                              keyboardType: TextInputType.text,
                                              style: AppStyles.greyTextStyle.copyWith(fontSize: 18),
                                              onSaved: (val) => setState(() => sponserFirstName = val),
                                            ),
                                          ),
                                        ],
                                      ),
                                      Container(
                                        ...
                                        child: ButtonTheme(
                                          ...
                                          child: RaisedButton(
                                            ...
                                            onPressed: () {
                                              commanditaireFormKey.currentState.validate();
                                            },
