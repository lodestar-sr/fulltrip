    ...
    return ModalProgressHUD(
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              title: Text('Informations', style: AppStyles.blackTextStyle.copyWith(fontSize: 17, fontWeight: FontWeight.w500)),
              centerTitle: true,
            ),
                          ...
                          child: ConstrainedBox(
                              ...
                              child: Container(
                                  ...
                                  child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                    Text(
                                      'Mon identité',
                                      style: AppStyles.darkGreyTextStyle.copyWith(fontSize: 15, color: AppColors.backButtonColor),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.only(top: 15.0, bottom: 5.0),
                                      child: GestureDetector(
                                        onTap: () => Navigator.of(context).pushNamed('Commanditaire'),
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            context.watch<AuthProvider>().getCommanditaireBadge() > 0 ? Container(
                                              height: 14,
                                              width: 14,
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            context.watch<AuthProvider>().getPhoneBadge() > 0 ? Container(
                                              height: 14,
                                              width: 14,
                                              decoration: BoxDecoration(
                                                color: Colors.red,
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            context.watch<AuthProvider>().getRaisonBadge() > 0 ? Container(
                                              height: 14,
                                              width: 14,
                                              decoration: BoxDecoration(
                                                color: Colors.red,
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            context.watch<AuthProvider>().getPaymentBadge() > 0 ? Container(
                                              height: 14,
                                              width: 14,
                                              decoration: BoxDecoration(
                                                color: Colors.red,
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 5.0, bottom: 5.0),
                                      child: GestureDetector(
                                        onTap: () => Navigator.of(context).pushNamed('mesdocuments'),
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            Row(
                                            ...
                                            context.watch<AuthProvider>().getDocBadge() > 0 ? Container(
                                              height: 14,
                                              width: 14,
                                              decoration: BoxDecoration(
                                                color: Colors.red,
