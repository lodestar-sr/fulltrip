...
class TransPortInProgress extends StatefulWidget {
  TransPortInProgress({Key key}) : super(key: key);

  @override
  _TransPortInProgressState createState() => _TransPortInProgressState();
}

class _TransPortInProgressState extends State<TransPortInProgress> {
                          ...
                          child: Container(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, mainAxisSize: MainAxisSize.max, children: [
                                Container(
                                  ...
                                  child: ListView(
                                    shrinkWrap: true,
                                    padding: EdgeInsets.only(left: 4, right: 4, top: 10, bottom: 55),
