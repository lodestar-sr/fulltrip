...
class _ProposeLot4State extends State<ProposeLot4> {
  ...
  onSubmit() async {
    ...
    Navigator.of(context).pushNamedAndRemoveUntil(
      ...
      (_) => false,
      arguments: {
        'text': 'Ce lot a été publié, attendez que les transporteurs le réservent.',
      },
    );
  }
                          ...
                          Padding(
                            ...
                            child: Theme(
                              ...
                              child: ExpansionTile(
                                ...
                                children: <Widget>[
                                  Text('Informations', style: AppStyles.blackTextStyle.copyWith(fontSize: 22, fontWeight: FontWeight.w500)),
                                  Padding(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text('${lot.arrivalLocationType}', style: AppStyles.blackTextStyle.copyWith(color: AppColors.backButtonColor, fontSize: 14)),
                                            lot.arrivalAccessType.isNotEmpty
                                                ...
                                                : Container(),
                                            lot.arrivalAccessType.isNotEmpty
                                                ? Text('${lot.arrivalAccessType}', style: AppStyles.blackTextStyle.copyWith(color: AppColors.backButtonColor, fontSize: 14))
                                                : Container(),
                                            lot.arrivalFloors.isNotEmpty
                                                ...
                                                : Container(),
                                            lot.arrivalFloors.isNotEmpty
                                                ? Text('${lot.arrivalFloors}', style: AppStyles.blackTextStyle.copyWith(color: AppColors.backButtonColor, fontSize: 14))
                                                : Container(),
                                          ],
                                        ),
                                      ],
