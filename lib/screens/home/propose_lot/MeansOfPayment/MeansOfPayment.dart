...
class MeansOfPayment extends StatefulWidget {
  MeansOfPayment({Key key}) : super(key: key);

  @override
  _MeansOfPaymentState createState() => _MeansOfPaymentState();
}

class _MeansOfPaymentState extends State<MeansOfPayment> {
  String firstname = '';
  String iban = '';
  String bic = '';
