...
class Search__ extends StatefulWidget {
  Search__({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Search__State();
}

class _Search__State extends State<Search__> {
  List<Lot> lots = [];
